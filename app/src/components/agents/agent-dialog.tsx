  ...
  if (connectors.size === 0 && skills.length === 0) {
    return (
      <>
        ...
        {/*
         * Shown on the empty screen as well as the full one, and this is the branch that matters
         * most. A Bot imported from a template arrives granted nothing by design, so "nothing
         * granted yet" beside a list of asks nobody has answered is the exact state an
         * administrator opens this section to resolve.
         */}
        <TemplateRequests agentId={agentId} />
      </>
    );
  }
